...
const server = http.createServer((req, res) => {
    ...
    if (parsedUrl.pathname === '/') {
        ...
        req.on('end', () => {
            ...
            const { name, phoneNumber, dob, email, gender, password, address } = userData;
            ...
            fs.readFile('user.json', 'utf8', (err, data) => {
                ...
                if (userExists) {
                    ...
                    // Save user data
                    const user = { name, phoneNumber, dob, email, gender, password, address };
                    saveUserData(user);
